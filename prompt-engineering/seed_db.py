    ...
    for case in combined_data:
        ...
        for party in case['parties']:
            ...
            for counsel in party['counsels']:
                ...
                counsel_title = counsel['counsel_title']
...
if __name__=="__main__":
    ...
    json_filenames = ['gpt_response','gpt1_response',
                      'gpt2_response','gpt3_response',
                      'gpt4_response','gpt5_response']
    
    manual_json = get_all_metadata(file_names)
    gpt_json = combine_json(json_filenames)
